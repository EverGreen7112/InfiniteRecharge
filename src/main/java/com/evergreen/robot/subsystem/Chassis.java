...
public class Chassis extends SubsystemBase {
    ...
    private final double DEFAULT_DRIVE_SPEED = 0.5;

    public void resetSpeed() {
        m_speedModifier = DEFAULT_DRIVE_SPEED;
    }
    ...
    //===============================COMMAND PARAMETERS===============================
    /**
     * The multiplier of the joystick's value, in simple drive.
     */
    private double m_speedModifier = DEFAULT_DRIVE_SPEED;
    ...
    //rotating the chassis in a certain speed
    ...
    /**
     *
     * @return a command that drives the chassis according to the joysticks and the set speed modifier.
     */
    public Command simpleDriveCMD() {
